...
export default function Cards({ scores, curatedUsers, loading }) {
  ...
  useEffect(() => {
    ...
    //       dateObject,
    //     });
    //     let filteredScores = dateObject.scores.filter((user) => {
    //       return curatedUsers.some((cu) => cu.name == user.name && cu.show);
    //     });
    //     console.log({
    //       line: 32,
    //       filteredScores,
    ...
    //     let newDateObject = { date: dateObject.date, scores: filteredScores };
